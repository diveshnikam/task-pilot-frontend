...
const AddTask = () => {
  ...
  const isPageLoading =
    projectsLoading || teamsLoading || usersLoading || tagsLoading;

  const pageError = projectsError || teamsError || usersError || tagsError;
        ...
        <div className="col-12 col-md-9 ">
          ...
          >
            ...
            <div className="mt-4">
              ...
              {updateMessage && (
                <p className="text-dark mt-3 mb-5 fw-semibold">
