...
const TeamDetails = () => {
  ...
  const buildUrl = () => {
    let url = `https://task-pilot-backend-5sb3.onrender.com/teams/${teamId}/tasks?`;
  ...
  const error =
    teamRes.error || projectRes.error || userRes.error || tagRes.error;
  if (error) {
    return (
  ...
  const team = teamRes.leadData;
  const projects = projectRes.leadData;
    ...
    >
      <div className="row justify-content-center g-4 mx-0">
        ...
        <div className="col-12 col-md-9">
          <div className="mb-4 text-center text-md-start mb-5">
            ...
            >
              <i className="bi bi-pencil-square me-1"></i> Edit Team
            </Link>
          </div>

          <div className="row g-2 g-md-3 mb-5 mt-5">
